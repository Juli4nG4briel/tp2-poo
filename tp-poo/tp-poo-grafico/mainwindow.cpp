...
QByteArray MainWindow::ignorarPreposiciones(QByteArray ocurrencia){
    ocurrencia.replace(" de ", "");
    ocurrencia.append(" ");
    ocurrencia.prepend(" ");

    ocurrencia.replace(" sin ", "");
    ocurrencia.append(" ");
    ocurrencia.prepend(" ");

    ocurrencia.replace(" la ", "");
    ocurrencia.append(" ");
    ocurrencia.prepend(" ");

    ocurrencia.replace(" las ", "");
    ocurrencia.append(" ");
    ocurrencia.prepend(" ");

    ocurrencia.replace(" los ", "");
    ocurrencia.append(" ");
    ocurrencia.prepend(" ");

    ocurrencia.replace(" en ", "");
    ocurrencia.append(" ");
    ocurrencia.prepend(" ");

    ocurrencia.replace(" el ", "");
    ocurrencia.append(" ");
    ocurrencia.prepend(" ");
